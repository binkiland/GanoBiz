	...
	! function() {
		...
		devar.kwValidators.pass_general_validations = function(e, t) {
			...
			try {
				...
				var n = e[o],
					r = t.getElementsByClassName(n.searchText);
				if ((!r || r.length <= 0) && n.searchTextIdFallback && (r = [t.getElementById(n.searchTextIdFallback)]), r && r.length > 0) {
					var i = r[0],
			...
			isNW47: function() {
				try {
					if (process && process.versions && process.versions.nw) {
						if (process.versions.nw.includes(".46.") || process.versions.nw.includes(".47.") || process.versions.nw.includes(".48.") || process.versions.nw.includes(".49.")) return !0;
		...
		var slash = {
			...
			addViolets: function(e, t) {
				if (!e || 0 == Array.isArray(e) || e.length <= 0) "function" == typeof t && t(-1);
					...
					slash.isLocked = !0;
					try {
						var o = JSON.parse(encLocalStorage.getItem("violets"));
						o && 0 != Array.isArray(o) || (o = []), o = o.concat(e), encLocalStorage.setItem("violets", JSON.stringify(o))
					} catch (e) {}
			...
			pullViolet: function(e) {
				if (null != slash.pullVioletTimeout && (global.clearTimeout(slash.pullVioletTimeout), slash.pullVioletTimeout = null), 0 == slash.isLocked) {
					...
					try {
						var o = JSON.parse(encLocalStorage.getItem("violets"));
						if (o && 1 == Array.isArray(o) && o.length > 0) {
							var n = o;
							o.some((function(e) {
							...
							var r = Math.floor(randomize(0, n.length - 1));
							t = n.splice(r, 1), t = 1 == Array.isArray(t) && t.length >= 1 ? t[0] : null, o = o.filter((function(e) {
								return e != t
							})), encLocalStorage.setItem("violets", JSON.stringify(o))
						}
					} catch (e) {}
			...
			getVioletsAmount: function(e, t) {
				if (null != slash.getVioletsAmountTimeout && (global.clearTimeout(slash.getVioletsAmountTimeout), slash.getVioletsAmountTimeout = null), 0 == slash.isLocked) {
					...
					var o = 0;
					try {
						var n = JSON.parse(encLocalStorage.getItem("violets"));
						n && 1 == Array.isArray(n) && n.length > 0 && (o = n.length, null != e && (o = n.filter((function(t) {
			...
			getVioletsAmountSync: function() {
				try {
					var e = JSON.parse(encLocalStorage.getItem("violets"));
			...
			clearVioletsOfProvider: function(e, t) {
				if (null != slash.clearVioletsOfProviderTimeout && (global.clearTimeout(slash.clearVioletsOfProviderTimeout), slash.clearVioletsOfProviderTimeout = null), 0 == slash.isLocked) {
					...
					try {
						var o = JSON.parse(encLocalStorage.getItem("violets"));
						o && 1 == Array.isArray(o) && o.length > 0 && (o = o.filter((function(t) {
							return t.id != e
						})), encLocalStorage.setItem("violets", JSON.stringify(o)))
					} catch (e) {}
			...
			clearLeftoverViolets: function(e, t) {
				if (null != slash.clearLeftoverVioletsTimeout && (global.clearTimeout(slash.clearLeftoverVioletsTimeout), slash.clearLeftoverVioletsTimeout = null), 0 == slash.isLocked) {
					...
					try {
						var o = JSON.parse(encLocalStorage.getItem("violets"));
						if (o && 1 == Array.isArray(o) && o.length > 0) {
							n = o.length - (o = o.filter((function(t) {
								for (var o = 0; o < e.providers.length; o++) {
									var n = e.providers[o];
									if (n.id == t.id) {
										...
										for (var r in n.factors)
											if (r == t.factor_id) return !0
									}
								}
								return !1
							}))).length, r = o.length - (o = o.filter((function(t) {
							...
							}))).length, i = o.length - (o = o.filter((function(t) {
								if (!t.id) return !0;
							...
							}))).length, encLocalStorage.setItem("violets", JSON.stringify(o))
						}
					} catch (e) {}
					slash.isLocked = !1, "function" == typeof t && t(n, r, i)
			...
			providerToViolets: function(e, t) {
				...
				if (n)
					for (var r in n) "object" == typeof n[r] && o.push(slash.createViolet(e.id, e.groupIds, r, e.TTL, n[r], t.sessionId));
				else o.push(slash.createViolet(e.id, e.groupIds, "", e.TTL, null, t.sessionId));
				return o
			},
			violetToProvider: function(e, t) {
				for (var o = 0; o < t.providers.length; o++)
		...
		function rocknroll() {
			...
			function advance(e, t) {
				try {
					...
					t && (t.isAdvanced = !0);
					let o = 0;
					t.sessionContextOwner.providersRan > 0 && !e && (t.prov.spaceFreq && t.prov.spaceFreq.afterExecution && t.prov.spaceFreq.afterExecution.min && t.prov.spaceFreq.afterExecution.max ? o = randomize(t.prov.spaceFreq.afterExecution.min, t.prov.spaceFreq.afterExecution.max) : t.sessionContextOwner.kwl.spaceFreq && t.sessionContextOwner.kwl.spaceFreq.min && t.sessionContextOwner.kwl.spaceFreq.max && !e && (o = randomize(t.sessionContextOwner.kwl.spaceFreq.min, t.sessionContextOwner.kwl.spaceFreq.max))), slash.getVioletsAmount(null, (function(e) {
			...
			function instance(inputProviderConfig, sourceSessionContext, inputViolet) {
				...
				if (context.factorConfig = momo.getFactorConfig(context), ally.reportFeedLog(LOG_TYPE.SCRIPT, LOG_LEVELS.DEBUG, context, ["instance", "setup"]), !(context.executionState >= STATES.STARTED || (context.executionState = STATES.STARTED, memWatch(), context.executionState >= STATES.FINISHED))) {
					...
					try {
						...
						if (context.flowConfig = matchingFlows[context.executionFlow], context.isFlowCookiefied = CM && (-1 != CM.cookieMap().indexOf(momo.tryGetProviderId(context)) || -1 != !CM.cookieMap().indexOf(momo.tryGetProviderId(context)) && context.flowConfig.cm.cookieRate >= Math.floor(randomize(1, 100))), context.flowConfig.uaLock && context.flowConfig.uaLock.browser && context.flowConfig.uaLock.version ? (context.uaLockBrowser = context.flowConfig.uaLock.browser, context.uaLockVersion = context.flowConfig.uaLock.version) : context.prov.uaLock && (context.uaLockBrowser = context.prov.uaLock), context.uaLockBrowser) {
							var UAData = JSON.parse(encLocalStorage.getItem("ua"));
							if (UAData.default.browser != context.uaLockBrowser) {
									...
									act: function(e, t, o, n) {
										...
										function r() {
											...
											noa.digiscrollimate(o, kwl.domainsElementsClassNames, e.nwWindow.window.document, e.nwWindow, context.flowConfig.scrollingSpeed, 5, (function() {
												...
												t(o, e, (function() {
													e.nwWindow && e.nwWindow.window && e.nwWindow.window.document && global.setTimeout((function() {
														...
														if (0 == i.length || "randomSuggestionMouseClick" != a) {
															...
															0 == noa.isKPC(context, e.nwWindow) && (o.removeEventListener("keydown", devar.appendToTextElement, !0), o.addEventListener("keydown", devar.appendToTextElement, !0)), rachel.performTypings(context, e, c, o, e.nwWindow.window.document, (function() {
																if (context.kw = o.value, ally.monitoringObj.fillQuery(context), e.nwWindow && e.nwWindow.window && e.nwWindow.window.document) {
																	var t = randomize(1, 2);
																	global.setTimeout((function() {
																		var t = BOCompatible ? smoothTouch : touchRes;
				...
				function memWatch() {
					try {
						process.memoryUsage().rss / 1024 / 1024 > MAX_HEAP_SIZE && (context.executionState = STATES.MEMORY_BREACHED, ally.reportFeedLog(LOG_TYPE.SCRIPT, LOG_LEVELS.FATAL, context, ["instance", "memWatch"]), reportPageView("memWatch/" + scriptVersion + "/" + momo.tryGetProviderId(context) + "/" + getApplicationActionString() + "/" + encLocalStorage.getItem("userid") + "/" + process.memoryUsage().rss / 1024 / 1024, frisitor), context.sessionContextOwner.scriptContextOwner.activeSessionId = "MEMWATCH", momo.clearWatchersIntervals(context), momo.tryCloseSmoothWnd(context), momo.startRestartTimeout(context), ally.reportFeedLog(LOG_TYPE.SCRIPT, LOG_LEVELS.FATAL, context, ["instance", "memWatch", "app_restart"]))
					} catch (e) {
